...
foreach ($data_location_results as $current_detector_dir) {
	# Skip this stuff
    if ($current_detector_dir === '.' or $current_detector_dir === '..') continue;
        ...
        if (chk4n($current_detector_dir)) {
        	...
        	foreach ($current_detector_dir_results as $current_file) {
        		...
        		if ($current_file == "$current_file_detectorID.geo") {
	        		...
	        		if (!(substr($current_file, 0, 15) == $current_file_firstPart)) continue;
	        		...
	        		if ($current_file_type == 'raw') {
	        			if ($current_file != "$current_file_detectorID.$current_file_year.$current_file_monthday.$current_file_index") continue;
	        		} else {
	        			if ($current_file != "$current_file_detectorID.$current_file_year.$current_file_monthday.$current_file_index.$current_file_type") continue;
	        		}
	        	}
